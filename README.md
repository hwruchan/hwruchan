...
- 🏫 [HUNITY] 학과 학생회 행사 기획 총괄 및 예산 관리 - **총무부장** <sub>(24. 01. ~ 24. 12.)</sub>
- ☕ [바람커피] 원두 로스팅 및 핸드드립 브루잉 - **로스터 & 바리스타** <sub>(22. 09. ~ 24. 11.)</sub>
- 🎙️ [SMBS] 교육방송국 콘텐츠 제작 총괄 및 정기 라디오 아나운싱 - 정국원 및 수습국원 <sub>(22. 09. ~ 24. 02.)</sub> , **아나운서 부장** <sub>(22. 09. ~ 24. 08.)</sub>
- 📊 [BAMBOO] 학술 스터디, 데이터 분석 수업 진행 및 학술 대회 기획·운영 - 부원 <sub>(22. 09. ~ 24. 12.)</sub> , **총무 & 멘토** <sub>(25. 01. ~ 25. 12.)</sub>
- 📚 [이예은단비국어] 학생 출결 관리, 학부모 상담 응대 및 교육용 교재 제작 - **운영지원** <sub>(21. 05. ~ 22. 02.)</sub>
- 📐 [뿌리와샘] 고등 수학·과학 보충 강의 진행 및 학습 콘텐츠 제작 - **교무조교** <sub>(19. 02. ~ 19. 09.)</sub>
---

## 🤝 Projects & Programs
- 🤖 [oneTeam] 자체 MCP 기반 Custom AI 에이전트 활용 학교 특화 시스템 - 기획 & 개발 <sub>(25. 03. ~ 25. 12.)</sub>
...
- 👤 [AVA] 실종자 정보 기반 아바타 생성 및 재현 서비스 - 기획 <sub>(24. 05. ~ 24. 06.)</sub>
